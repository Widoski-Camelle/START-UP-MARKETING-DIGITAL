...
<head>
    ...
    <title>Marketing Digital | Conception Graphique</title>
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <!-- Page Header -->
    <header class="header header-mini-4"> 
      <div class="header-title">Conception Graphique</div> 
      <nav aria-label="breadcrumb">
         <ol class="breadcrumb">
            <li class="breadcrumb-item"><a class="text-white text-decoration-underline" href="/">Accueil</a></li>
            <li class="breadcrumb-item active" aria-current="page">Conception Graphique</li>
         </ol>
      </nav>
   </header>
    <!-- End of Page Header -->    
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6">
                    <div class="img-wrapper">
                        <div class="after"></div>
                        <img src="../imgs/img-15.jpg" class="w-100" alt="About Us">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="img-wrapper">
                        ...
                        <img src="../imgs/img-16.jpg" class="w-100" alt="About Us">
                    </div>  
                </div>
            </div>
            <!-- End of Row -->
            <p class="text-dark text-center mt-5 display-5">
                Faites briller votre marque avec notre service de conception graphique professionnel, créant des visuels 
                époustouflants et accrocheurs qui captiveront votre audience et renforceront votre image de marque.
            </p>
        </div>  
        <!-- End of Container -->
