...
<head>
    ...
    <title>Marketing Digital | Audit</title>
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <!-- Page Header -->
    <header class="header header-mini-5"> 
      <div class="header-title">Audit</div> 
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6">
                    <div class="img-wrapper">
                        <div class="after"></div>
                        <img src="../imgs/img-11.jpg" class="w-100" alt="About Us">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="img-wrapper">
                        ...
                        <img src="../imgs/img-12.jpg" class="w-100" alt="About Us">
                    </div>  
                </div>
            </div>
            <!-- End of Row -->
            <p class="text-dark text-center mt-5 display-5">
                Optimisez votre présence en ligne et dévoilez les opportunités d'amélioration grâce à notre service d'audit de 
                sites web et réseaux sociaux, pour maximiser votre performance et renforcer votre impact numérique.
            </p>
        </div>  
        <!-- End of Container -->
