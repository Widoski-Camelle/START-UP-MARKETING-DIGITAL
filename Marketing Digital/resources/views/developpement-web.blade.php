...
<head>
    ...
    <title>Marketing Digital | Développement web</title>
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <!-- Page Header -->
    <header class="header header-mini-3"> 
      <div class="header-title">Développement web</div> 
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6">
                    <div class="img-wrapper">
                        <div class="after"></div>
                        <img src="../imgs/img-13.jpg" class="w-100" alt="About Us">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="img-wrapper">
                        ...
                        <img src="../imgs/img-14.jpg" class="w-100" alt="About Us">
                    </div>  
                </div>
            </div>
            <!-- End of Row -->
            <p class="text-dark text-center mt-5 display-5">
                Donnez vie à votre vision en ligne avec notre service de développement web sur mesure, créant des sites web 
                modernes, fonctionnels et engageants pour propulser votre entreprise vers de nouveaux sommets.
            </p>
        </div>  
        <!-- End of Container -->
