...
<head>
    ...
    <title>Marketing Digital | Publicité</title>
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <!-- Page Header -->
    <header class="header header-mini-2"> 
      <div class="header-title">Publicité</div> 
      <nav aria-label="breadcrumb">
         <ol class="breadcrumb">
            <li class="breadcrumb-item"><a class="text-white text-decoration-underline" href="/">Accueil</a></li>
            <li class="breadcrumb-item active" aria-current="page">Publicité</li>
         </ol>
      </nav>
    </header>
    <!-- End of Page Header -->    
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6">
                    <div class="img-wrapper">
                        <div class="after"></div>
                        <img src="../imgs/img-9.jpg" class="w-100" alt="About Us">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="img-wrapper">
                        ...
                        <img src="../imgs/img-10.jpg" class="w-100" alt="About Us">
                    </div>  
                </div>
            </div>
            <!-- End of Row -->
            <p class="text-dark text-center mt-5 display-5">
                Déployez une stratégie publicitaire percutante sur les plateformes Facebook, Google, TikTok et Instagram
                pour atteindre votre audience cible, augmenter votre visibilité et stimuler vos résultats commerciaux.
            </p>
        </div>  
        <!-- End of Container -->
